module DE1_SoC #(parameter MAX = 3125000) (CLOCK_50, CLOCK2_50, FPGA_I2C_SCLK, FPGA_I2C_SDAT,
	...
	HEX0, HEX1, HEX2, HEX3, HEX4, HEX5, LEDR, V_GPIO,KEY,  VGA_R, VGA_G, VGA_B, VGA_BLANK_N, VGA_CLK, 
	VGA_HS, VGA_SYNC_N, VGA_VS);
...
//	assign writedata_right = sample_dout;
    ...
    get_image img (.CLOCK_50, .reset, .A, .B, .C, .D, .E, .F, .G, .full, .all_done, .RAM_addr,
